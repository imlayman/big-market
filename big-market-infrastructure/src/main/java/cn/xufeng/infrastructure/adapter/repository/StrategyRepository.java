...
import cn.xufeng.domain.strategy.model.valobj.*;
import cn.xufeng.domain.strategy.repository.IStrategyRepository;
import cn.xufeng.infrastructure.persistent.dao.*;
import cn.xufeng.infrastructure.persistent.po.*;
...
import static cn.xufeng.types.enums.ResponseCode.UN_ASSEMBLED_STRATEGY_ARMORY;
...
public class StrategyRepository implements IStrategyRepository {
    ...
    @Override
    public void upupdateStrategyAwardStock(Long strategyId, Integer awardId) {
        StrategyAward strategyAward = new StrategyAward();
        strategyAward.setStrategyId(strategyId);
        strategyAward.setAwardId(awardId);
