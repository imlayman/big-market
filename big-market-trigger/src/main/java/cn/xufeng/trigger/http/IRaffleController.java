package cn.xufeng.trigger.http;

import cn.xufeng.domain.strategy.IRaffleAward;
...
import cn.xufeng.trigger.api.IRaffleService;
...
public class IRaffleController implements IRaffleService {
    ...
    public Response<List<RaffleAwardListResponseDTO>> queryRaffleAwardList(@RequestBody RaffleAwardListRequestDTO requestDTO) {
        try {
            ...
            log.info("查询抽奖奖品列表配失败 strategyId：{}", requestDTO.getStrategyId(),e);
